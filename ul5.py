...
board.digital[trigger_pin].mode = board.MODE_PWM  # Use PWM mode for output
board.digital[echo_pin].mode = board.MODE_INPUT  # Use INPUT mode for input
...
def get_distance():
    ...
    pulse_duration = board.digital[echo_pin].read_pulse(1, timeout=0.1)  # Timeout in seconds
